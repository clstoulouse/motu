 ...
 * @version $Revision: 1.4 $ - $Date: 2009-09-03 14:47:41 $
 */
        ...
        try {
            ...
            if (expand) {
                ...
                if (validate) {
                    ...
                    List<String> errors = serviceMetadata.validateServiceMetadataFromString(iso19139Schema, localIso19139SchemaPath,  localIso19139RootSchemaRelPath, xmlTemplate);
                    if (errors.size() > 0) {
