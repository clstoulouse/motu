...
public class Range {
    ...
    protected List<String> rangeClosures;
    ...
    /**
     * Shall be included unless the default value applies. Gets the value of the rangeClosures property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the rangeClosures property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRangeClosures().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getRangeClosures() {
        if (rangeClosures == null) {
            rangeClosures = new ArrayList<String>();
        }
        return this.rangeClosures;
    }
