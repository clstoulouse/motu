...
@XmlType(name = "ReferenceGroupType", propOrder = {
    "abstractReferenceBases"
})
@XmlRootElement(name = "ReferenceGroup")
    ...
    extends BasicIdentificationType
{
    ...
    protected List<JAXBElement<? extends AbstractReferenceBaseType>> abstractReferenceBases;

    /**
     * Gets the value of the abstractReferenceBases property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the abstractReferenceBases property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAbstractReferenceBases().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<? extends AbstractReferenceBaseType>> getAbstractReferenceBases() {
        if (abstractReferenceBases == null) {
            abstractReferenceBases = new ArrayList<JAXBElement<? extends AbstractReferenceBaseType>>();
        }
        return this.abstractReferenceBases;
    }
