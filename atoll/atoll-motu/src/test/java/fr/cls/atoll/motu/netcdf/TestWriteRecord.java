...
public class TestWriteRecord extends TestCase {
    ...
    public void testNC3WriteWithRecordVariables() throws IOException {
        ...
        ArrayInt.D1 validRange = new ArrayInt.D1(2);
        validRange.set(0, 0);
        validRange.set(1, 100);
        ncfile.addVariableAttribute("rh", "range", validRange);
