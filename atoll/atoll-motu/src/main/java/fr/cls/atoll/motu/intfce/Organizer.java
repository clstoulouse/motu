...
import fr.cls.atoll.motu.configuration.ConfigService;
import fr.cls.atoll.motu.configuration.MotuConfig;
import fr.cls.atoll.motu.data.ExtractCriteria;
import fr.cls.atoll.motu.data.Product;
import fr.cls.atoll.motu.data.ProductPersistent;
import fr.cls.atoll.motu.data.SelectData;
import fr.cls.atoll.motu.data.ServiceData;
import fr.cls.atoll.motu.data.ServicePersistent;
import fr.cls.atoll.motu.data.VarData;
import fr.cls.atoll.motu.data.ServiceData.Language;
import fr.cls.atoll.motu.exception.MotuExceedingCapacityException;
import fr.cls.atoll.motu.exception.MotuExceedingQueueCapacityException;
import fr.cls.atoll.motu.exception.MotuExceedingQueueDataCapacityException;
import fr.cls.atoll.motu.exception.MotuExceedingUserCapacityException;
...
import fr.cls.atoll.motu.exception.MotuInvalidQueuePriorityException;
import fr.cls.atoll.motu.exception.MotuInvalidRequestIdException;
...
import fr.cls.atoll.motu.queueserver.QueueServerManagement;
import fr.cls.atoll.motu.sdtnameequiv.StandardNames;
import fr.cls.atoll.motu.xml.XMLErrorHandler;
import fr.cls.atoll.motu.xml.XMLUtils;
import fr.cls.atoll.motumsg.MotuMsgConstant;
import fr.cls.atoll.motumsg.xml.ErrorType;
import fr.cls.atoll.motumsg.xml.ObjectFactory;
import fr.cls.atoll.motumsg.xml.RequestSize;
import fr.cls.atoll.motumsg.xml.StatusModeResponse;
import fr.cls.atoll.motumsg.xml.StatusModeType;
import fr.cls.atoll.motumsg.xml.TimeCoverage;
...
public class Organizer {
    ...
    private static final String CONFIG_SCHEMA_PACK_NAME = "fr.cls.atoll.motu.configuration";

    /** The Constant OPENDAP_SCHEMA_PACK_NAME. */
    private static final String OPENDAP_SCHEMA_PACK_NAME = "fr.cls.atoll.motu.opendap.server";

    /** The Constant TDS_SCHEMA_PACK_NAME. */
    private static final String TDS_SCHEMA_PACK_NAME = "fr.cls.atoll.motu.tds.server";

    /** The Constant STDNAME_EQUIV_PACK_NAME. */
    private static final String STDNAME_EQUIV_PACK_NAME = "fr.cls.atoll.motu.sdtnameequiv";
    ...
    /**
     * Number of leap seconds per day expect on <BR/>1. days when a leap second has been inserted, e.g. 1999
     * JAN 1. <BR/>2. Daylight-savings "spring forward" or "fall back" days.
     */
    ...
    private void initVelocityEngine() throws MotuException {
        ...
        try {
            ...
            throw new MotuException("Error in initVelocityEngine - Unable to intialize Velocity engine", (Throwable) e);
        }
    ...
    private void getAvailableServicesHTML(Writer out) throws MotuException {
        ...
        try {
            ...
            throw new MotuException("Error in getAvailableServicesHTML", (Throwable) e);
        }
    ...
    public static synchronized Properties getPropertiesInstance() throws MotuException {
        if (props == null) {
            ...
            try {
                ...
                throw new MotuException("Error in getPropertiesInstance", (Throwable) e);
            }
            if (props == null) {
    ...
    public static synchronized MotuConfig getMotuConfigInstance() throws MotuException {
        if (motuConfig == null) {
            ...
            try {
                ...
                throw new MotuException("Error in getMotuConfigInstance", (Throwable) e);
            }
    ...
    public static ServicePersistent getServicesPersistent(String key) {
        ...
        ServicePersistent servicePersistent = (ServicePersistent) Organizer.servicesPersistent.get(serviceName);
    ...
    public static ServicePersistent putServicesPersistent(String key, ServicePersistent value) {
        return (ServicePersistent) Organizer.servicesPersistent.put(key.toLowerCase(), value);
    }
    ...
    public static ServicePersistent removeServicesPersistent(String key) {
        return (ServicePersistent) Organizer.servicesPersistent.remove(key.toLowerCase());
    }
    ...
    public static synchronized StandardNames getStdNameEquiv() throws MotuException {
        ...
        if (stdNameEquiv == null) {
            ...
            try {
                ...
                throw new MotuException("Error in getStdNameEquiv", (Throwable) e);
            }
    ...
    public ServiceData getServices(String key) {
        return (ServiceData) this.servicesMap.get(key.trim());
    }
    ...
    public ServiceData putServices(String key, ServiceData value) {
        return (ServiceData) this.servicesMap.put(key.trim(), value);
    }
    ...
    public ServiceData removeServices(String key) {
        return (ServiceData) this.servicesMap.remove(key);
    }
