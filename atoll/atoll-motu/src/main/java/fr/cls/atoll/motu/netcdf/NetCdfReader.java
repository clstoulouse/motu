...
import fr.cls.atoll.motu.sdtnameequiv.StandardName;
...
public class NetCdfReader {
     ...
     */
    public double getDoubleValue(String varName, String attributeName) throws NetCdfAttributeNotFoundException, NetCdfVariableNotFoundException,
     ...
     * @throws NetCdfAttributeException invalid request (see error message).
     */
    public String getStringValue(String varName, String attributeName) throws NetCdfAttributeNotFoundException, NetCdfVariableNotFoundException,
            NetCdfAttributeException {
        Variable variable = getVariable(varName);
    ...
    public static String getStringValue(Variable variable, Attribute attribute) throws NetCdfAttributeException {
        ...
        if (!attribute.isString()) {
            throw new NetCdfAttributeException(variable, attribute, String
                    .format("Error in getStringValue - Unable to get string value from attribute - Attribute type (%s) is not STRING ", attribute
    ...
    public static String getStringValue(Attribute attribute) throws NetCdfAttributeException {
        ...
        if (!attribute.isString()) {
            throw new NetCdfAttributeException(attribute, String
                    .format("Error in getStringValue - Unable to get string value from attribute - Attribute type (%s) is not STRING ", attribute
                            .getDataType().toString()));
        }
    ...
    public static double initializeMissingData(Variable var, Array data) throws MotuNotImplementedException {
        ...
        if (dataType.equals(DataType.DOUBLE)) {
            ...
            throw new MotuNotImplementedException(String
                    .format("initialization with data type %s is not implemented (NetCdrfReader - initializeMissingData", dataType.toString()));
        }
        return fillValue;
    }
