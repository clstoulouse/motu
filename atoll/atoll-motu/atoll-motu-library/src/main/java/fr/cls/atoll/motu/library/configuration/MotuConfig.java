...
// Generated on: 2009.06.03 at 12:32:29 PM CEST 
//
 ...
 *       &lt;attribute name="sftpSessionTimeOut" type="{http://www.w3.org/2001/XMLSchema}duration" default="PT5M" />
 *       &lt;attribute name="strictHostKeyChecking" default="no">
 *         &lt;simpleType>
...
public class MotuConfig {
    ...
    public Period getSftpSessionTimeOut() {
        if (sftpSessionTimeOut == null) {
            return new JodaPeriodAdapter().unmarshal("PT5M");
        } else {
