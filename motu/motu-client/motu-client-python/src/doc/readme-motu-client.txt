...
==================
 ...
 The program parameters are contained in an ini file. This file is located in the following directory:
   ...
   - on Unix platforms: $HOME/py_motu_gateway
   - on Windows platforms: %USERPROFILE%\py_motu_gateway
 ...
 The expected structure of file is:
  		...
  		pwd=secret
  		verbose=False
  		gateway=http://web-qt.cls.fr/mis-gateway-servlet/Motu?
  		service_url=http://purl.org/myocean/ontology/individual/myocean
  		service_name=CLS-TOULOUSE-FR-MOTU-REST
  		product_name=dataset-duacs-nrt-blacksea-en-sla-l3
  		out_dir=./out_dir
  		out_name=test.nc
