...
public class MotuCasException extends Exception {
     ...
     */
    public MotuCasException(String message, Throwable cause) {
        super(message, cause);
     ...
     * @param message message to post.
     */
    public MotuCasException(String message) {
        super(message);
    }
     ...
     * @param cause native exception.
     */
    public MotuCasException(Throwable cause) {
        super(cause);
    }
    ...
    /**
     * @see MotuCasException#getMessage()
