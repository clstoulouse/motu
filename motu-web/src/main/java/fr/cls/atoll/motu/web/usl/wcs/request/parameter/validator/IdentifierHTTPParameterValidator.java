 ...
 */
public class IdentifierHTTPParameterValidator extends AbstractHTTPParameterValidator<String> {

    public IdentifierHTTPParameterValidator(String parameterName_, String parameterValue_) {
        super(parameterName_, parameterValue_);
    }

    public IdentifierHTTPParameterValidator(String parameterName_, String parameterValue_, String defaultValue_) {
