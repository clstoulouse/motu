...
public class ObjectUtils<K> {
    ...
    public K getValue(Object object, String keyField)
    ...
    public static String getValueAsString(Object object, String keyField)
            throws IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        if (LOG.isDebugEnabled()) {
    ...
    public static String getValueAsString(Object object, String... keyFields)
            throws IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        if (LOG.isDebugEnabled()) {
            LOG.debug("getValueAsString(Object, String) - start");
        }
    ...
    public static String getValueAsString(Object object, Iterable<String> keyFields)
