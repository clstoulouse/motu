...
public class RunnableHttpExtraction extends RunnableExtraction {
     ...
     */
    public RunnableHttpExtraction(int priority, int range, ExtractionParameters extractionParameters) {
        super(priority, range, extractionParameters);
    }
    ...
    // */
    // private void init(HttpServletResponse responseP, String modeP, Condition requestEndedConditionP,
    // ReentrantLock lockP) {
    //
