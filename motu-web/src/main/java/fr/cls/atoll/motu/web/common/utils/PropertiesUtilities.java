...
public class PropertiesUtilities {
    ...
    /**
     * Replace from an input stream the names of system variables that follows the scheme ${var} <tt> by their
    ...
    // * @throws IOException if file is not a <tt>.properties</tt> file or if it is not found in the
    // classpath.
    ...
    // if (in == null) {
    // throw new FileNotFoundException("The resource file " + propertiesFileResource + " has not been found in
    // the classpath");
    // }
    // try {
    // props.load(in);
    ...
    /**
     * Replace in the properties values the name of the system variable that follows the scheme <tt>${var}
     * <tt> with their corresponding values.
     * 
