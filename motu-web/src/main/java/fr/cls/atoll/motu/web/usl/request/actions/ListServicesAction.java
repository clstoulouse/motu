...
import fr.cls.atoll.motu.web.usl.response.velocity.model.converter.ServiceListConverter;
    ...
    public void process() throws MotuException {
        ...
        for (ConfigService cs : BLLManager.getInstance().getConfigManager().getMotuConfig().getConfigService()) {
            if (StringUtils.isNullOrEmpty(catalogType)
                ...
                context.put("serviceList",
                            ServiceListConverter.converServiceList(BLLManager.getInstance().getConfigManager().getMotuConfig().getConfigService()));
