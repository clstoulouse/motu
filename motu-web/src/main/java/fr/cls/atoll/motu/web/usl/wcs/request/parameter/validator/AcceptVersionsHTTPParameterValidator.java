 ...
 */
public class AcceptVersionsHTTPParameterValidator extends AbstractHTTPParameterValidator<String> {

    public AcceptVersionsHTTPParameterValidator(String parameterName_, String parameterValue_) {
        super(parameterName_, parameterValue_);
    }

    public AcceptVersionsHTTPParameterValidator(String parameterName_, String parameterValue_, String defaultValue_) {
