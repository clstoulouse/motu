...
public class ProductDeferedExtractNetcdfThread extends Thread {
    ...
    // */
    // public ProductDeferedExtractNetcdfThread(StatusModeResponse statusModeResponse, ExtractionParameters
    ...
    // * @param extractionParameters the extraction parameters
    // */
    // public ProductDeferedExtractNetcdfThread(String productDeferedExtractNetcdfStatusFilePathName,
    ...
    // */
    // public static void setStatusDone(StatusModeResponse statusModeResponse, Product product) throws
    // MotuException {
    //
    ...
    // */
    // public static Product extractData(ExtractionParameters params) throws MotuException {
    //
    ...
    // null);
    // } else if (!StringUtils.isNullOrEmpty(params.getServiceName()) &&
    // !StringUtils.isNullOrEmpty(params.getProductId())) {
    // product = extractData(params.getServiceName(),
    // params.getListVar(),
    // params.getListTemporalCoverage(),
    // params.getListLatLonCoverage(),
    ...
    // params.getResponseFormat());
    // } else {
    // throw new MotuInconsistencyException(String.format("ERROR in extractData: inconsistency parameters :
    // %s", params.toString()));
    // }
    //
    // return product;
    ...
    //
    // /**
    // * Extracts data from a location data (url , filename) according to criteria (geographical and/or
    // temporal
    ...
    // Writer out,
    // OutputFormat responseFormat) throws MotuInvalidDateException, MotuInvalidDepthException,
    // MotuInvalidLatitudeException,
    // MotuInvalidLongitudeException, MotuException, MotuInvalidDateRangeException,
    // MotuExceedingCapacityException,
    // MotuNotImplementedException, MotuInvalidLatLonRangeException, MotuInvalidDepthRangeException,
    ...
    // currentService.extractData(product, listVar, listTemporalCoverage, listLatLonCoverage,
    // listDepthCoverage, selectData, dataOutputFormat);
    // if (LOGGER.isDebugEnabled()) {
    ...
    // case XML:
    // case ASCII:
    // throw new MotuNotImplementedException(String.format("extractData - Format %s not implemented",
    ...
    // String productId) throws MotuInvalidDateException, MotuInvalidDepthException,
    // MotuInvalidLatitudeException,
    // MotuInvalidLongitudeException, MotuException, MotuInvalidDateRangeException,
    // MotuExceedingCapacityException,
    // MotuNotImplementedException, MotuInvalidLatLonRangeException, MotuInvalidDepthRangeException,
    ...
    // * @throws NetCdfAttributeException the net cdf attribute exception
    // */
    // private Product getProductInformation(String locationData) throws MotuException,
