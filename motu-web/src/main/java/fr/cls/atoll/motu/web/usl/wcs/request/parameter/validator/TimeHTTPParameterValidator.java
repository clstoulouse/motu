 ...
 */
public class TimeHTTPParameterValidator extends AbstractHTTPParameterValidator<String> {

    public TimeHTTPParameterValidator(String parameterName_, String parameterValue_) {
        super(parameterName_, parameterValue_);
    }

    public TimeHTTPParameterValidator(String parameterName_, String parameterValue_, String defaultValue_) {
