...
public class ExtractCriteriaLatLon extends ExtractCriteriaGeo {
     ...
     * @param lonHigh longitude high
     */
    public ExtractCriteriaLatLon(String latLow, String lonLow, String latHigh, String lonHigh) throws MotuInvalidLatitudeException,
     ...
     * @uml.property name="latLonRect"
     */
    public void setLatLonRect(String latLow, String lonLow, String latHigh, String lonHigh) throws MotuInvalidLatitudeException,
            MotuInvalidLongitudeException {
     ...
     */
    public List<Range> toRange(CoordinateSystem cs, double[] rangeValueLat, double[] rangeValueLon) throws MotuException,
            MotuInvalidLatLonRangeException, MotuNotImplementedException {
    ...
    private void getRangeValues(GridCoordSys gcs, Range rangeLat, Range rangeLon, double[] rangeValueLat, double[] rangeValueLon)
        ...
        if ((xaxis instanceof CoordinateAxis1D) && (yaxis instanceof CoordinateAxis1D)) {
            ...
            throw new MotuNotImplementedException("Coordinate axes that are not 1D or 2D/LatLon are not implemented in ExtractCriteriaLatLon.toRange");
        }
...
//        }
     ...
     */
    public void computeLatLonMinMax(CoordinateAxis2D latAxis, CoordinateAxis2D lonAxis, int minj, int mini, int maxj, int maxi, double minx, double maxx)
            throws MotuException {
