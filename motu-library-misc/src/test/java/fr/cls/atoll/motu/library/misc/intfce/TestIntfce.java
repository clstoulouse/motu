...
public class TestIntfce {
    ...
    public static void productInformation() {
        ...
        try {
            ...
            // String productId =
            // "http://purl.org/myocean/ontology/product/database#dataset-duacs-ran-global-en-sla-l3";
    ...
    public static void productExtractDataFromInventory() {
        ...
        String service = "http://purl.org/myocean/ontology/service/database#SLTAC";
        ...
        // String productId =
        // "http://purl.org/myocean/ontology/product/database#dataset-duacs-ran-global-e1-sla-l3";
            ...
            for (String serviceName : services) {
                ...
                for (Entry<String, Product> productEntries : mapProducts.entrySet()) {
                    ...
                    if (depthCoverage != null) {
                        System.out.println(String.format("Depth coverage: %f to %f",
                                                         productMetaData.getDepthCoverage().min,
                                                         productMetaData.getDepthCoverage().max));
                    }
                    if (depthUnits != null) {
    ...
    public static void testGetProductMetadataInfo() {
        ...
        try {
            ...
            // String locationData =
            // "http://tomcat.nersc.no:8080/thredds/dodsC/topaz/mersea-ipv2/arctic/tmipv2a-class1-b-be";
            String locationData = "sftp://atoll:atoll@atoll-dev.cls.fr/home/atoll/distrib/hoa/publication/inventories/dataset-duacs-ran-global-en-sla-l3__cls-toulouse-fr-sltac-motu-rest.xml";
            // String locationData =
            // "http://opendap.mercator-ocean.fr/thredds/dodsC/mercatorPsy3v2_arc_mean_best_estimate";
            //
    ...
    public static void productExtractXYTopaz3() {

        String locationData = "http://tomcat.nersc.no:8080/thredds/dodsC/topaz/reanalysis-v1/assim/arc-class1-be";
        ...
        // if only start date is set, end date equals start date
        List<String> listTemporalCoverage = new ArrayList<String>();
        listTemporalCoverage.add("2008-09-30");
        listTemporalCoverage.add("2008-11-30");
    ...
    public static void productExtractAcri() {
        String locationData = "http://myocean-ftp.acri.fr:8080/thredds/dodsC/dataset-oc-acri-global-100km-chl-daily-ran";
        ...
        // if only start date is set, end date equals start date
        List<String> listTemporalCoverage = new ArrayList<String>();
        listTemporalCoverage.add("2010-10-25");
        listTemporalCoverage.add("2010-10-25");
    ...
    public static void productExtractXYHRMOD() {
        String locationData = "http://misgw-qt.cls.fr:61080/thredds/dodsC/HR_MOD";
        List<String> listVar = new ArrayList<String>();
        // add variable to extract
        // listVar.add("salinity");
        // listVar.add("u");
        ...
        // if only start date is set, end date equals start date
        List<String> listTemporalCoverage = new ArrayList<String>();
        listTemporalCoverage.add("2011-03-15");
        listTemporalCoverage.add("2011-03-15");
        ...
        List<String> listLatLonCoverage = new ArrayList<String>();
        listLatLonCoverage.add("40");
        listLatLonCoverage.add("-179.905288");
        listLatLonCoverage.add("90");
        listLatLonCoverage.add("180");
